...
addTechBtn.addEventListener('click',function (ev) {
 ...
 form.addEventListener('submit', function (ev) {
  ...
  inputRows.forEach(function (row) {
    const techName = document.querySelectorAll(`#${row.id} input[name="techName-${row}"]`).value
    const techExp = document.querySelectorAll(`#${row.id} input[type="radio"]:checked`).value
